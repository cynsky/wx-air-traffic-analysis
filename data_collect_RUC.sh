#! /bin/sh
# This is a script for downloading RUC weather data from NOMADS, a repository run by NOAA.
...
do
	...
	do
		...
		do
			...
			mget ruc2*0000_002.grb
			mget ruc2*0300_002.grb
			mget ruc2*0600_002.grb
			mget ruc2*0900_002.grb
			mget ruc2*1200_002.grb
			mget ruc2*1500_002.grb
			mget ruc2*1800_002.grb
			mget ruc2*2100_002.grb
			cd ..
		done
		# end the ftp session
		bye
