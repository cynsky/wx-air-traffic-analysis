...
pca2_k5 = kmeans(pca1,5)
exp1_k5 = kmeans(pca1,5)
exp2_k5 = kmeans(pca1,5)
exp3_k5 = kmeans(pca1,5)
pca1_k10 = kmeans(pca1,10)
pca2_k10 = kmeans(pca1,10)
exp1_k10 = kmeans(pca1,10)
exp2_k10 = kmeans(pca1,10)
exp3_k10 = kmeans(pca1,10)
pca1_k20 = kmeans(pca1,20)
pca2_k20 = kmeans(pca1,20)
exp1_k20 = kmeans(pca1,20)
exp2_k20 = kmeans(pca1,20)
exp3_k20 = kmeans(pca1,20)
