...
for (date_ind in 1:length(rel_dates)) {
	...
	crosswinds[date_ind,4] = findwind(TAF_data,rel_dates[date_ind],"KJFK",c(19.5,23.5),rwy13_cross)
	...
	crosswinds[date_ind,8] = findwind(TAF_data,rel_dates[date_ind],"KEWR",c(19.5,23.5),rwy4_cross)
	...
	crosswinds[date_ind,12] = findwind(TAF_data,rel_dates[date_ind],"KLGA",c(19.5,23.5),rwy4_cross)
	...
	crosswinds[date_ind,16] = findwind(TAF_data,rel_dates[date_ind],"KLGA",c(19.5,23.5),rwy13_cross)
}
